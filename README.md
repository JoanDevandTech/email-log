...
![WordPress Compatibility](https://img.shields.io/badge/wordpress-4.0%2B-brightgreen.svg)
![PHP Version](https://img.shields.io/badge/php-7.3%2B-purple.svg)
...
- Contact Form 7
- Gravity Forms
- Any plugin that uses the standard WordPress `wp_mail()` function
...
<details>
<summary><strong>Where can I view the logged emails?</strong></summary>
...
<details>
<summary><strong>Does this plugin prevent emails from being sent?</strong></summary>
...
<details>
<summary><strong>How much storage space will the email logs use?</strong></summary>
...
<details>
<summary><strong>Can I automatically delete old email logs?</strong></summary>

Currently, you need to manually delete logs. Automatic deletion based on age is planned for a future update.
</details>

<details>
<summary><strong>Does this work with WooCommerce emails?</strong></summary>
...
<details>
<summary><strong>Does this plugin work with SMTP plugins?</strong></summary>
...
2. **Screen options panel** - Customize which columns are displayed
3. **HTML preview** - View the HTML version of logged emails
4. **Plain text preview** - View the plain text version of logged emails
5. **Date filter** - Search emails by date range
6. **Dashboard widget** - Email log summary on your dashboard
...
- 🛠️ Initial modifications by Joan Dev & Tech
...
🌐 **Plugin URI:** [https://joandev.com/email-log/](https://joandev.com/email-log/)  
🐙 **GitHub:** [https://github.com/JoanDevandTech/email-log](https://github.com/JoanDevandTech/email-log)  
