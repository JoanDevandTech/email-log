...
/**
 * Acciones realizadas en el listado de registros.
 *
 * @since 2.0.0
 */
class LogListAction implements Loadie {
	...
	/**
	 * Callback AJAX para mostrar el contenido del correo.
	 *
		...
		if ( count( $log_items ) > 0 ) {
			...
			<div id="tabs">
				<ul data-active-tab="<?php echo absint( $active_tab ); ?>">
					<li><a href="#tabs-text"><?php esc_html_e( 'Contenido del correo (texto plano)', 'email-log' ); ?></a></li>
					<li><a href="#tabs-preview"><?php esc_html_e( 'Vista previa como HTML', 'email-log' ); ?></a></li>
				</ul>
